...
{   
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Filoso: la acidez es uno de los atributos más importantes ya que es responsable de la frescura. En algunos vinos este sabor es más intenso que en otros y el punto máximo, tolerable, es cuando imprime una sensación táctil que parece cortar a su paso.',
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Franco: expresión siempre positiva. En primer lugar da cuenta de un vino sin defectos y a la vez que tanto sus aromas como su sabor van en una misma línea.',
    ...
    Color:'Rosado',
    ml:750,
    Descripcion:'Gastronómico: el vino es un alimento y si bien este término puede parecer redundante, los cierto es que se utiliza en aquellos vinos que reúnen las condiciones para acompañar diversos estilos de cocina o se disfrutan mejor con un plato delante.',
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Graso: este descriptor se refiere a la textura del vino. Así como están aquellos que fluyen ligeros y lineales otros despliegan una untuosidad a su paso, como aceitosa o grasa acompañada de buen sabor.',
    ...
    Color:'Blanco',
    ml:750,
    Descripcion:'Jugoso: tintos jóvenes y expresivos con buena acidez y sabor. Son vinos que llenan el paladar y gustan. Generalmente destacan por su perfil frutal.',
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Largo: un vino debe dejar su sabor en boca por un buen tiempo. Si la sensación que imprime es agradable y prolongada entonces se debe destacar. Lo ideal es que su sabor supere los diez segundos en permanencia.',
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Lineal: cuando un vino ataca el paladar con buena frescura y fluir ligero realiza un recorrido directo al final de boca. Allí se expresa y realza sabores. Es decir que son vinos fluidos y vivaces. ',
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Mineral: es un término que despierta polémicas. Algunos lo usan con los vinos con aromas de asfalto húmedo, grafito o cemento fresco. Otros para describir la textura cuándo deja un efecto semisecante o polvoriento como al borrar un pizarrón, sensación de tiza.',
    ...
    Color:'Rosado',
    ml:750,
    Descripcion:'Nervioso: no siempre la acidez es una virtud. Cuando se convierte en una molestia se puede recurrir a esta expresión.',
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Piracina: más que un descriptor es un compuesto aromático. Sin embargo, se lo menciona a la hora de describir el perfil especiado de un vino, principalmente cuando este recuerda al pimiento verde fresco.',
    ...
    Color:'Blanco',
    ml:750,
    Descripcion:'Profundo: este término se puede usar para describir el color de un vino cuando éste es concentrado y oscuro o bien para referirse a aromas penetrantes e intensos.',
    ...
    Color:'Tinto',
    ml:750,
    Descripcion:'Versátil: ideal para hablar de vinos que pueden desempeñarse bien en diversas situaciones, por ejemplo, con carnes rojas o pastas, junto a un plato principal o durante la sobremesa, etc. Es un atributo siempre positivo.',
